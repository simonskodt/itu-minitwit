...
public interface IMessageRepository
{
    ...
    Task<DBResult<IEnumerable<Message>>> GetAllNonFlaggedAsync(int limit, CancellationToken ct = default);
    ...
    Task<DBResult<IEnumerable<Message>>> GetAllNonFlaggedByUsernameAsync(string username, int limit, CancellationToken ct = default);

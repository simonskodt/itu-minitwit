\begin{titlepage}
    \begin{center}
        ...
        \normalsize
        % Number of words: \wordcount{main}\\
        Number of characters \textit{including} spaces: \charcountspaces{main}\\
        Number of characters \textit{excluding} spaces: \charcount{main}
    \end{center}
\end{titlepage}